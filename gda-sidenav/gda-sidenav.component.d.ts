...
export declare class GdaSidenav implements AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<GdaSidenav, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<GdaSidenav, "gda-sidenav, .gda-sidenav, [gda-sidenav]", never, { "mode": "mode"; }, {}, never, ["gda-sidenav-header, .gda-sidenav-header, [gda-sidenav-header]", "*"], false, never>;
}
