    ...
    constructor(elementRef, renderer, gdaTabsService, tabsService) {
        ...
        this.sub1 = this.tabsService.buttonActivated.subscribe((button) => {
            ...
            if (this.id === button.id) {
                this.button = button;
                if (this.tabsService.preventTabs > ((_a = this.button) === null || _a === void 0 ? void 0 : _a.id)) {
                    this.leftEnter = '-100%';
                }
                else if (this.tabsService.preventTabs < ((_b = this.button) === null || _b === void 0 ? void 0 : _b.id)) {
                    this.leftEnter = '100%';
                }
            }
            else if (this.tabsService.preventTabs === ((_c = this.button) === null || _c === void 0 ? void 0 : _c.id)) {
                if (button.id > ((_d = this.button) === null || _d === void 0 ? void 0 : _d.id)) {
                    this.leftLeave = '-100%';
                }
                else if (button.id < ((_e = this.button) === null || _e === void 0 ? void 0 : _e.id)) {
                    this.leftLeave = '100%';
                }
            }
            else {
            ...
            setTimeout(() => {
                var _a;
                this.enabled = ((_a = this.button) === null || _a === void 0 ? void 0 : _a.active);
                setTimeout(() => {
                    this.animations = false;
                }, 0);
            }, 0);
        ...
        this.sub3 = this.tabsService.checkActive.subscribe(() => {
            ...
            this.enabled = (button === null || button === void 0 ? void 0 : button.active) || false;
...
class GdaTabsComponent {
    ...
    get setStyle() {
        var _a, _b;
        return {
            'min-height': ((((_b = (_a = this.tabContentEl) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.offsetHeight) || 0) + this.tabsService.heightTabActive) + 'px',
    ...
    set indexTab(val) {
        setTimeout(() => {
            ...
            if (this.buttons.length && this.buttons[val] && !this.buttons[val].active) {
                this.tabsService.preventTabs = ((_a = this.buttons.find((button) => button.active)) === null || _a === void 0 ? void 0 : _a.id) || 0;
    ...
    loadButtons(reload = false) {
        setTimeout(() => {
            ...
            if (this.buttons && this.buttons.length) {
                ...
                if (this.indexTabVal !== (((_a = this.buttons.find((button) => button.active)) === null || _a === void 0 ? void 0 : _a.id) || 0)) {
                    this.indexTabActivated.emit(((_b = this.buttons.find((button) => button.active)) === null || _b === void 0 ? void 0 : _b.id) || 0);
                }
                setTimeout(() => {
                ...
                if ((_c = this.tabContentEl) === null || _c === void 0 ? void 0 : _c.nativeElement) {
    ...
    setTab(event, buttonEl, i) {
        ...
        setTimeout(() => {
            ...
            if (this.elementRef.nativeElement.querySelectorAll('gda-tab')[i]) {
                ...
                this.tabsService.preventTabs = ((_a = this.buttons.find((button) => button.active === true)) === null || _a === void 0 ? void 0 : _a.id) || 0;
